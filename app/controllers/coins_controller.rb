class CoinsController < ApplicationController
  ...
  before_action :set_mining_type_options, only: %i[ new create edit update show]
  ...
  private
    # Used to query data from MiningType Model and set to a variable - @mining_type_options
